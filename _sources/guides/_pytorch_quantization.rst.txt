...
.. tip::
    ...
    please refer to :ref:`quantization-formats`.
...
refer to :ref:`quantization-configs` for the list of quantization configs supported by default. You may also define your own quantization config as
